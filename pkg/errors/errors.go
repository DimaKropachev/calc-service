...
var (
	ErrInvalidToken         error = errors.New("в выражении не должны присутствовать символы кроме цифр и допустимых знаков математических операций")
	...
	ErrBeforeSecondBracket  error = errors.New("перед закрывающейся скобкой ожидалось число")
	ErrAfterSecondBracket   error = errors.New("после закрывающейся скобки ожидалась математическая операция")
	...
	ErrEmptyExpression      error = errors.New("пустое выражение")
